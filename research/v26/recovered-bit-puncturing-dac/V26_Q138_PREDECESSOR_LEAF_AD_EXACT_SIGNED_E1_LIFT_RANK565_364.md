...
- A6 clean run `32160207690`: inside A6 direct rank<=565; outside the forced A6 core the admitted direct upper is189. Hence uniformly `a2<=565`.
- D5 clean run `32160149637`: inside D5 direct rank<=179; outside the forced D5 core the admitted direct upper is364. Hence uniformly `d2<=364`.
