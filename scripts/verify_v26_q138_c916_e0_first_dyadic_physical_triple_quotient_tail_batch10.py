...
TARGET = int(os.environ.get('C916_PHYSICAL_QUOTIENT_TAIL10_TARGET', '0'))
TARGETS = (
    {
        'source_index': 4,
        'triple': (3, 7, 62),
        'raw_holes': 56,
        'raw_hole_digest': '5be36012bde831299071a7e24e481398221b547424a455453a4db9944157ef0f',
        'raw_image_digest': 'efc1e10920c7e02e0a94120f973a82ffc1f8498b5af3928963663cd86e2d01bc',
    },
    {
        'source_index': 5,
        'triple': (3, 7, 67),
    ...
    },
    {
        ...
        'raw_image_digest': '46bfeb1a9b7799551982a6037e19151ab78bdd6ef559a9497dbab28c110c6ac3',
    },
    {
        'source_index': 7,
        'triple': (3, 7, 111),
        'raw_holes': 48,
        'raw_hole_digest': 'e3ba2166ebdcd214466a84e07c6521b50a75b1df3008a77cb1e6319138f092c5',
        'raw_image_digest': '685acd7939556d17787303a5078dc44772ab1b3eebda215659770f4ea083a4f2',
    },
)
...
def analyze():
    ...
    out = {
        ...
        'target': TARGET,
        'source_tail_index': expected['source_index'],
        'triple': list(triple),
    ...
    if qholes:
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL10_OBSTRUCTION')
        print('theorem=this exact physical ternary tail obstruction descends to a forbidden relation on the existing sign-reflection quotient')
    else:
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL10_SIGN_ONLY')
        print('theorem=this exact physical ternary tail obstruction is sign-only at the existing quotient and cannot be propagated without refinement')
    print('boundary=only the emitted tail-batch target is frozen; other physical higher-order factors remain open')
    print('ALPHA_PASS=0')
    return out
