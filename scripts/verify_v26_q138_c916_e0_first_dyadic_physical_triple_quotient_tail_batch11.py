...
TARGET = int(os.environ.get('C916_PHYSICAL_QUOTIENT_TAIL11_TARGET', '0'))
TARGETS = (
    {
        'source_index': 8,
        'triple': (3, 7, 112),
...
def analyze():
    ...
    if qholes:
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL11_OBSTRUCTION')
        ...
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL11_SIGN_ONLY')
