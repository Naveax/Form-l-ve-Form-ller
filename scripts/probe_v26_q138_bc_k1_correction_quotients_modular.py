...
def main():
    # Already-admitted exact combined quotient theorem:
    # B: 668 support frequencies +144 quotient =812.
    # C: 788 support frequencies +184 quotient =972.
    ...
    for pos in 'BC':
        ...
        # Integer matrices satisfy rank_Fp <= rank_Q. Also E,H are subspaces
        # of G, so each rational quotient rank is <= rank_Q(G/U)=qG.
        # Therefore mE==qG or mH==qG is an exact rational equality certificate.
        certE=(mE==qG)
        certH=(mH==qG)
        print('position',pos,
