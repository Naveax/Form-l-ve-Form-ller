...
def main():
    ...
    expected_hist = {11:9,12:62,13:79,14:9,15:22,16:22,17:14,18:8,19:3,20:14,21:65,22:40,23:8,24:12,25:20,26:12,27:13,28:2,29:8,30:7,31:11,32:5,33:4,34:2,35:2,36:3,37:1,38:2,39:2,40:4,41:2,42:3,44:2,45:1,46:1,47:2,48:2,49:3,50:2,51:1,52:1,53:1,54:2,55:3,56:1,57:3,59:1,60:2}
    assert out['safe_evaluation_bit_histogram'] == expected_hist
    a,b,c = out['worst_edges'][:3]
    assert (a['lo'],a['hi'],a['safe_evaluation_bits']) == (110,166,60)
    assert a['exact_override'] is True and a['function_lambda'] == 70 and a['generic_safe_evaluation_bits'] == 60 and a['quadratic_residual_dim'] == 13 and a['fiber_affine_residual'] is True
    assert (b['lo'],b['hi'],b['safe_evaluation_bits']) == (55,110,60)
    assert b['exact_override'] is True and b['function_lambda'] == 64 and b['generic_safe_evaluation_bits'] == 64 and b['quadratic_residual_dim'] == 12 and b['fiber_affine_residual'] is False
    assert (c['lo'],c['hi'],c['safe_evaluation_bits']) == (0,110,59)
    assert c['exact_override'] is False and c['function_lambda'] == 65
    assert sum(expected_hist.values()) == 498 and expected_hist[60] == 2 and expected_hist[55] == 3
