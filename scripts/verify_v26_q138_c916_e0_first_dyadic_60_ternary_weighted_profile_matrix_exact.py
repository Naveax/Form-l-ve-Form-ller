#!/usr/bin/env python3
"""Prepared exact weighted profile matrix for the 60-ternary C916 inventory.
...
EXPECTED_TOTAL_FACTOR_COUNT = 60
...
def run_profile(target: int, output: Path) -> dict:
    ...
    try:
        ...
        if int(regression["exact_profile_count"]) == 0:
            ...
            full = run_one(len(factors), "all_current_60_ternary")
    ...
    out = {
        ...
        "all_current": full,
        "decision": "C916_60_TERNARY_WEIGHTED_EXACT_PROFILE_SUMMAND",
    }
