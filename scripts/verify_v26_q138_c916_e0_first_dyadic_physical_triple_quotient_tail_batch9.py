...
TARGET = int(os.environ.get('C916_PHYSICAL_QUOTIENT_TAIL9_TARGET', '0'))
TARGETS = (
    {
        'source_index': 1,
        'triple': (3, 7, 11),
...
def analyze():
    ...
    if qholes:
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL9_OBSTRUCTION')
        ...
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL9_SIGN_ONLY')
