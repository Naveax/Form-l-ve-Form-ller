...
TARGET = int(os.environ.get('C916_PHYSICAL_QUOTIENT_TAIL12_TARGET', '0'))
TARGETS = (
    {
        'source_index': 12,
        'triple': (3, 7, 136),
        'raw_holes': 8,
        'raw_hole_digest': '4051cd89eff2d3d03567246c40a3e8d329a5dbde355e11ee5c361733e2f39aab',
        'raw_image_digest': '5073b06653c72c9322c48fa4a098fa5dd81405b5f7eec57f6add0850545f1d4e',
    },
    {
        'source_index': 14,
        'triple': (3, 7, 144),
...
def analyze():
    ...
    if qholes:
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL12_OBSTRUCTION')
        ...
        print('PASS V26_Q138_C916_E0_FIRST_DYADIC_PHYSICAL_TRIPLE_QUOTIENT_TAIL12_SIGN_ONLY')
