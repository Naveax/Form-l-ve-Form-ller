...
def main():
    ...
    for pos in 'BC':
        ...
        base=len(U)
        assert (base,base+qG)==expected[pos],(pos,base,qG)
    ...
    print('PASS PROBE V26_Q138_BC_K1_CORRECTION_QUOTIENTS_FRESH')
    print('scope=exact ZZ Walsh quotient decomposition of current K1 correction spaces; no alternative K0 rank assumed')
