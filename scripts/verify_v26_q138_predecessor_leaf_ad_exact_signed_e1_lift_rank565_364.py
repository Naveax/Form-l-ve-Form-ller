...
def main():
    ...
    assert A_DIRECT==565 and D_DIRECT==364
    a2=A_DIRECT; d2=D_DIRECT
    seqs=(
        [3,219,a2]+[2048]*8,
        [36,812,2048]+[2048]*8,
        [84,972,2048]+[2048]*8,
    ...
    expected=[27216,4793472,286719696,6955731216,79723547424,535328405616,2657484843456,10194932924416]
    ...
    assert total<budget
    print('A_e1_singleton_supports',sum(info['A'][3].values()),'activity',info['A'][0],'e0_budget',info['A'][1],'second_lift_rank<=',info['A'][2])
    print('D_e1_singleton_supports',sum(info['D'][3].values()),'activity',info['D'][0],'e0_budget',info['D'][1],'second_lift_rank<=',info['D'][2])
